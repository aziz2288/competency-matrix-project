<form method="POST" action="/project/update">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ $project->description }}" required autocomplete="description">
